...
const string strMessageMagic = "EDRcoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int64_t nMoneySupply)
{
	...
	// 0% after 22m total coins
	if (nMoneySupply > 22000000 * COIN)
		nSubsidy = 0;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EDRcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "EDRcoin Genesis Block";
        CTransaction txNew;
        if (!fTestNet)
        {
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0xc70a81a1032008fe8eec0d63a179f97feec39e585101dc934e0005d0739810a8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf3, 0xe4, 0xd2, 0xe3 };
